...
public class ITimesheetServiceTest extends IEntityDataServiceTest<ITimesheetService, Timesheet> {
	...
	/**
	 * @verifies return the current timesheet for the billing
	...
	/**
	 * @verifies return null if the billing has no timesheets
	 * @see ITimesheetService#getCurrentTimesheet(org.openmrs.Provider)
	 */
	@Test
	...
	/**
	 * @verifies return the most recent timesheet if the billing is clocked into multiple timesheets
	 * @see ITimesheetService#getCurrentTimesheet(org.openmrs.Provider)
	 */
	@Test
