 ...
 */
package org.openmrs.module.cashier.base.entity;
...
public abstract class IMetadataDataServiceTest<S extends IMetadataDataService<E>, E extends OpenmrsMetadata>
	 ...
	 * @see org.openmrs.module.openhmis.commons.api.entity.IMetadataDataService#retire(OpenmrsMetadata, String)
	 */
	@Test
	 ...
	 * @see org.openmrs.module.openhmis.commons.api.entity.IMetadataDataService#getByNameFragment(String, boolean)
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	/**
	 * @verifies return all specified metadata records if paging is null
	 * @see org.openmrs.module.openhmis.commons.api.entity.IMetadataDataService#getAll(boolean, PagingInfo)
	 */
	@Test
