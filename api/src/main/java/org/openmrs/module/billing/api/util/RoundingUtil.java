...
public class RoundingUtil {
	 ...
	 * msgService.getMessage("openhmis.billing.rounding.itemName"); String description =
	 * msgService.getMessage("openhmis.billing.rounding.itemDescription"); // Department department =
