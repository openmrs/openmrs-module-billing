...
public class ReceiptGenerator {
    ...
    public static byte[] createBillReceipt(Bill bill) {
        ...
        DateTimeFormatter dateFormatter = DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT).withLocale(Context.getLocale());
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofLocalizedDateTime(FormatStyle.SHORT).withLocale(Context.getLocale());
