...
public class PrivilegeConstants {
	...
	public static final String[] PRIVILEGE_NAMES = new String[] { MANAGE_BILLS, ADJUST_BILLS, VIEW_BILLS, PURGE_BILLS,
	        ...
	        REQUEST_REFUNDS, APPROVE_REFUNDS, COMPLETE_REFUNDS, VIEW_REFUNDS, MANAGE_TIMESHEETS, VIEW_TIMESHEETS,
	        PURGE_TIMESHEETS, MANAGE_METADATA, VIEW_METADATA, PURGE_METADATA, APP_VIEW_CASHIER_APP,
