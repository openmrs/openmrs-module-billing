...
public class PrivilegeConstants {
	...
	public static final String REQUEST_REFUNDS = "Request Bill Refunds";
	
	public static final String APPROVE_REFUNDS = "Approve Bill Refunds";
	
	public static final String COMPLETE_REFUNDS = "Complete Bill Refunds";
	
	public static final String VIEW_REFUNDS = "View Bill Refunds";
	...
	protected static final String[] PRIVILEGE_NAMES = new String[] { MANAGE_BILLS, ADJUST_BILLS, VIEW_BILLS, PURGE_BILLS,
	        DELETE_BILLS, REFUND_MONEY, REPRINT_RECEIPT, MANAGE_BILL_DISCOUNTS, APPROVE_BILL_DISCOUNTS, VIEW_BILL_DISCOUNTS,
	        REQUEST_REFUNDS, APPROVE_REFUNDS, COMPLETE_REFUNDS, VIEW_REFUNDS, MANAGE_METADATA, VIEW_METADATA, PURGE_METADATA,
	        APP_VIEW_CASHIER_APP, APP_ACCESS_CASHIER_TASKS_PAGE, TASK_CREATE_NEW_BILL_PAGE, TASK_ADJUST_CASHIER_BILL,
	        TASK_MANAGE_CASHIER_MODULE_PAGE, TASK_MANAGE_CASHIER_METADATA, TASK_VIEW_CASHIER_REPORTS };
