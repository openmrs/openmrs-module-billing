...
public interface ITimesheetService extends IEntityDataService<Timesheet> {
	 ...
	 * 
	 * @param cashier The billing.
	 * @return The {@link Timesheet} or {@code null} is the billing is not clocked in.
	 * @should return the current timesheet for the billing
	 * @should return null if the billing has no timesheets
	 * @should return the most recent timesheet if the billing is clocked into multiple timesheets
	 ...
	 * @param cashier The billing.
	 * @param date The date.
	 * @return All the timesheets for the billing on the specified day.
