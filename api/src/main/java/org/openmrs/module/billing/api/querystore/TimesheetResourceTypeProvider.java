...
public class TimesheetResourceTypeProvider implements ResourceTypeProvider {
	
	private final TimesheetRecordSerializer serializer;
	
	public TimesheetResourceTypeProvider(TimesheetRecordSerializer serializer) {
