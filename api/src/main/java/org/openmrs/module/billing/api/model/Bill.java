...
public class Bill extends BaseOpenmrsData {
	...
	public BigDecimal getTotal() {
		...
		List<BillLineItem> billLineItems = getLineItems();
		if (billLineItems != null) {
			for (BillLineItem line : billLineItems) {
	...
	public BigDecimal getTotalPayments() {
		...
		Set<Payment> billPayments = getPayments();
	...
	private void checkAuthorizedToAdjust() {
		if (!Context.hasPrivilege(PrivilegeConstants.ADJUST_BILLS)) {
			throw new SecurityException("Access denied to adjust bill.");
		}
	}
