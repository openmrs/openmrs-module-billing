...
public class BillRefundResourceTypeProvider implements ResourceTypeProvider {
	
	private final BillRefundRecordSerializer serializer;
	
	public BillRefundResourceTypeProvider(BillRefundRecordSerializer serializer) {
