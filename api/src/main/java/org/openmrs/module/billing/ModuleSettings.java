...
public class ModuleSettings {
	...
	public static final String RECEIPT_REPORT_ID_PROPERTY = "openhmis.billing.defaultReceiptReportId";
	
	public static final String CASHIER_SHIFT_REPORT_ID_PROPERTY = "openhmis.billing.defaultShiftReportId";
	
	public static final String TIMESHEET_REQUIRED_PROPERTY = "openhmis.billing.timesheetRequired";
	
	public static final String ROUNDING_MODE_PROPERTY = "openhmis.billing.roundingMode";
	
	public static final String ROUND_TO_NEAREST_PROPERTY = "openhmis.billing.roundToNearest";
	
	public static final String ROUNDING_ITEM_ID = "openhmis.billing.roundingItemId";
	
	public static final String ROUNDING_DEPT_ID = "openhmis.billing.roundingDeptId";
	
	public static final String SYSTEM_RECEIPT_NUMBER_GENERATOR = "openhmis.billing.systemReceiptNumberGenerator";
	
	public static final String ADJUSTMENT_REASEON_FIELD = "openhmis.billing.adjustmentReasonField";
	
	public static final String ALLOW_BILL_ADJUSTMENT = "openhmis.billing.allowBillAdjustments";
	
	public static final String AUTOFILL_PAYMENT_AMOUNT = "openhmis.billing.autofillPaymentAmount";
	
	public static final String PATIENT_DASHBOARD_2_BILL_COUNT = "openhmis.billing.patientDashboard2BillCount";
	
	private static final Integer DEFAULT_PATIENT_DASHBOARD_2_BILL_COUNT = 4;
	
	public static final String DEPARTMENT_COLLECTIONS_REPORT_ID_PROPERTY = "openhmis.billing.reports.departmentCollections";
	
	public static final String DEPARTMENT_REVENUE_REPORT_ID_PROPERTY = "openhmis.billing.reports.departmentRevenue";
	
	public static final String SHIFT_SUMMARY_REPORT_ID_PROPERTY = "openhmis.billing.reports.shiftSummary";
	
	public static final String DAILY_SHIFT_SUMMARY_REPORT_ID_PROPERTY = "openhmis.billing.reports.dailyShiftSummary";
	
	public static final String PAYMENTS_BY_PAYMENT_MODE_REPORT_ID_PROPERTY = "openhmis.billing.reports.paymentsByPaymentMode";
